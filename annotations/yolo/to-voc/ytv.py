...
## coco classes
YOLO_CLASSES = ('0-no_smoking',
'1-danger_flammable _material',
'2-danger_electric_shock',
'3-danger_falling',
'4-danger_explosive_material_explosion',
'5-danger_toxic_chemicals',
'6-danger_corrosive_substance',
'7-danger_laser_radiation',
'8-danger_radioactive_material',
'9-danger_biological',
'10-ear_protection',
'11-use_safety_glasses',
'12-danger_slippery_surface',
'13-danger_oxidizing_substance',
'14-danger_of_hand_crushing')
...
def xml_transform(root, classes):  
    ...
    annopath = join(root, 'yolo', '%s.txt')
    imgpath = join(root, 'imgs', '%s.jpg')
    
    os.makedirs(join(root, 'voc'), exist_ok=True)
    outpath = join(root, 'voc', '%s.xml')
